...
public final class ServiceMessage {
    ...
    public static final String TASK_SKILL_DELETED = "task.skill.deleted";
    public static final String TASK_SKILLS_FETCHED = "task.skills.found";
    public static final String TASK_SKILL_UPDATED ="task.skill.updated";
    public static final String TASK_SKILL_FOUND ="task.skill.found" ;
